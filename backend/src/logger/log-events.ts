...
export const LogEvent = {
  ...
  LeadDeliveryEnabled: 'Lead Delivery Enabled',
  LeadDeliveryDisabled: 'Lead Delivery Disabled',
  LeadDeliverySending: 'Lead Delivery Sending',
  LeadDeliveryVerifyFailed: 'Lead Delivery Verification Failed',
